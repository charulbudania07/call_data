...
class CommentProvider with ChangeNotifier {
  ...
  Future<bool> submitCommentToServer({
    ...
    try {
      ...
      String endpoint = "comment?id=$id&actionType=$actionType&user_id=$userId&user_name=$name"
          "&callStatus=$callStatus&profileType=${profileType?.toLowerCase() ?? ""}"
          "&comment=$comment&isFollowUp=$isFollowUp&screenType=$screenType"; // 👈 added
